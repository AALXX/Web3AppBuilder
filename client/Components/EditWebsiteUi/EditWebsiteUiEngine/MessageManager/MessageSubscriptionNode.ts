...
export class MessageSubscriptionNode {
     ...
     * @param {string} code The message code being subscribed to.
     * @param {IMessageHandler} handler The message handler.
     * @param {MessageCallback} callback The message callback.
     */
...
export class MessageQueueNode {
    ...
    /**
     * Creates a new MessageSubscriptionNode.
     * @param {Message} message The message code being subscribed to.
     * @param {IMessageHandler} handler The message handler.
     * @param {MessageCallback} callback The message callback.
     */
