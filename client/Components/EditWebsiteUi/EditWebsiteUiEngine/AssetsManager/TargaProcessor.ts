...
class TargaHeader {
     ...
     */
    public initialize() {
        this.hasEncoding = this.imageType === TargaType.RLE_INDEXED || this.imageType === TargaType.RLE_RGB || this.imageType === TargaType.RLE_INDEXED;

        this.hasColorMap = this.imageType === TargaType.RLE_INDEXED || this.imageType === TargaType.INDEXED;

        this.isGreyColor = this.imageType === TargaType.RLE_GREY || this.imageType === TargaType.GREY;
    }
}

/**
 * targa processor class
 */
export class TargaProcessor {
        ...
        switch (header.pixelDepth) {
            case 8:
                if (header.isGreyColor) {
                    TargaProcessor.getImageDataGrey8(imageData.data, imageDataArray, palette, header.width, yStart, yStep, yEnd, xStart, xStep, xEnd);
                } else {
                    TargaProcessor.getImageData8(imageData.data, imageDataArray, palette, header.width, yStart, yStep, yEnd, xStart, xStep, xEnd);
                }
                break;
            case 16:
                if (header.isGreyColor) {
                    TargaProcessor.getImageDataGrey16(imageData.data, imageDataArray, palette, header.width, yStart, yStep, yEnd, xStart, xStep, xEnd);
                } else {
                    TargaProcessor.getImageData16(imageData.data, imageDataArray, palette, header.width, yStart, yStep, yEnd, xStart, xStep, xEnd);
                }
                break;
            case 24:
                TargaProcessor.getImageData24(imageData.data, imageDataArray, palette, header.width, yStart, yStep, yEnd, xStart, xStep, xEnd);
                break;
            case 32:
                TargaProcessor.getImageData32(imageData.data, imageDataArray, palette, header.width, yStart, yStep, yEnd, xStart, xStep, xEnd);
                break;
        }
     ...
     * @param {Uint8ClampedArray} indexes
     * @param {Uint8ClampedArray} colorMap
     * @param {number} width
     * @param {number} yStart
     * @param {number} yStep
     * @param {number} yEnd
